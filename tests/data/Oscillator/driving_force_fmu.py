...
class DrivingForce(Model):
    ...
    """
    def __init__(self, func:callable= func, ampl:float= 1.0, freq:float= 1.0, **kwargs):
        super().__init__("DrivingForce", "A simple driving force for an oscillator", "Siegfried Eisinger", **kwargs)
